		...
		player: {
			...
			/*	_game.player.model = _three.createModel(window.game.models.player, 12, [
				...
				*/
				...
				_game.player.shape = new CANNON.Box(new CANNON.Vec3(10, 10, 10))
				_game.player.rigidBody = new CANNON.Body(_game.player.mass, _game.player.shape, _cannon.createPhysicsMaterial(_cannon.playerPhysicsMaterial));
				...
				var bboxGeometry = new THREE.CubeGeometry(10, 10, 10);
			...
			_game.player.mesh = _cannon.addVisual(_game.player.rigidBody, null, new THREE.Mesh(bboxGeometry, bboxMaterial));
/*
