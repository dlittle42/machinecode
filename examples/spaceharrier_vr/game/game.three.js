...
window.game.three = function() {
	var _three = {
		...
		init: function(options) {
			...
			/*_three.camera.position.x=10;
			_three.camera.position.y=10;
			_three.camera.position.z=10;
			*/

			_three.controls = new THREE.OrbitControls( _three.camera, _three.domContainer );
		//	console.log(_three.controls)
		...
		render: function() {
			...
			_three.deltaTime = _three.clock.getDelta();
			
			//_three.camera.updateProjectionMatrix();


			_three.controls.update(_three.deltaTime);
